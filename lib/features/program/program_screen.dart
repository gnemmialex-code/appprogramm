...
class ProgramScreen extends ConsumerWidget {
        ...
        child: ListView(
          ...
          children: [
            ...
            if (_adaptiveCount(program, progress) > 0) ...[
              ...
              FadeSlideIn(
                child: SoftCard(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.tune_rounded, color: AppColors.ink),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  const Text('3 niveaux d\'apprentissage',
                      style: TextStyle(
  ...
  List<Widget> _buildParcours(
    ...
    for (var p = 0; p < program.parts.length; p++) {
      ...
      final partModulesDone =
          part.moduleIds.where(progress.completedModules.contains).length;
  ...
  int _adaptiveCount(Program program, ProgressState progress) {
    ...
    final allDone =
        progress.completedModules.length >= program.modules.length;
  ...
  void _lockedToast(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('🔒 Termine le niveau précédent pour débloquer celui-ci.'),
      ...
      child: Opacity(
        ...
        child: Row(
          children: [
            ...
            if (locked)
              const Icon(Icons.lock_rounded, color: AppColors.inkSoft, size: 20)
            else if (completed)
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Quiz transversal du niveau',
                      style: TextStyle(
